...
const CustomerDetailModal: React.FC<CustomerDetailModalProps> = ({ customer, loans, subscriptions, installments, onClose, deleteLoan, deleteSubscription, deleteInstallment, onEditLoan, onEditSubscription }) => {
